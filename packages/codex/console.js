...
exports.OperatorConsole = void 0;
exports.createOperatorConsole = createOperatorConsole;
...
class OperatorConsole {
    constructor() {
        ...
        this.signalBuffer = [];
        this.cycleBuffer = [];
        this.plateCounts = new Map();
        this.operatorCounts = new Map();
        this.fallbackActivations = 0;
        this.listeners = new Set();
        this.codex = (0, engine_1.createNonogramCodex)({
            initialPlate: 'I',
    ...
    generateTelemetry() {
        ...
        const meanCycleLatency = this.cycleBuffer.length > 0
        ...
        return {
            ...
            signalArrivalRate,
            plateDistribution: Object.fromEntries(this.plateCounts),
            operatorInvocations: Object.fromEntries(this.operatorCounts),
    ...
    getState() {
        ...
        const state = {
            ...
            currentCycle: null, // would be current cycle if in progress
...
exports.OperatorConsole = OperatorConsole;
/**
 * Create a new Operator Console instance
 */
function createOperatorConsole() {
